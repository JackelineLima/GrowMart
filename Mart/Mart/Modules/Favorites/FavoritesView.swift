...
//  Mart
//
//  Created by Jackeline Pires de Lima on 21/11/22.
//
...
public class FavoritesView: UIView {
    ...
    private lazy var headerView: HeaderView = {
        let view = HeaderView(textLabel: "favoritos",
                              imageStrig: "pencil")
...
extension FavoritesView: ViewCodable  {
    ...
    public func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            headerView.topAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: 24),
...
extension FavoritesView: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView,
        ...
        guard let favorite = delegate?.getFavorite(at: indexPath.row),
              let cell: FavoriteCell = .createCell(collectionView, cellForItemAt: indexPath) else {
